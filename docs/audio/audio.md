...
We can improve the chatbot to speak the answer rather than output text.
...
We can also bypass the keyboard and have the user speak the question to the chatbot.

This will create a conversation chatbot through voice.
