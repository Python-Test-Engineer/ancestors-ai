...
They are essentially snippets, litte notes that do not have to be structured in any way.
...
!!! tip "Example"
    A person is tagged a `Joe Bloggs` and whenever there is a post that references Joe Bloggs, it will be tagged with `Joe Bloggs`.
...
!!! tip "Example"
    `What was your first job?` - this can be used as a prompt to write a post about your first job and it may stimulate other posts like a person you were friends with at that job. 
...
At this time, this knowledge is not available to you.
